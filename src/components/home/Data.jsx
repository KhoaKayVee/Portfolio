...
const Data = () => {
  return (
    <div className="home__data">
        <h1 className="home__title">KayVee
        <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <p className="home__description">Tôi hiện tại đang làm phát triển giao diện website và phần mềm. Tôi sống ở HCM City, tôi đã theo ngành nghề và làm freelancer được 1 năm.</p>
