    ...
    <header className="header">
        <nav className="nav container">
            ...
            <div className='social'>
                    <a className="social__icon" href='https://www.facebook.com/ngoanhkhoa13062001/'>
                        <i className='fab fa-facebook-f icon'></i>
                    </a>
                    <a className="social__icon" href='https://www.instagram.com/kayvee0cap/'>
                        <i className='fab fa-instagram icon'></i>
                    </a>
                    <a className="social__icon" href='https://www.facebook.com/ngoanhkhoa13062001/'>
                        <i className='fab fa-twitter icon'></i>
                    </a>
                    <a className="social__icon" href='https://www.youtube.com/@khoangoanh2705'>
